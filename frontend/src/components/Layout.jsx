...
const Layout = ({ children }) => {
  ...
  return (
    <div className="flex h-screen bg-[#050510] text-slate-100 overflow-hidden noise-overlay font-sans">
      ...
      <aside className="w-24 md:w-64 flex flex-col border-r border-white/[0.06] bg-[#050510] relative z-20">
        ...
        <div className="p-6 border-t border-white/[0.06] space-y-6">
            ...
            <button 
                ...
                className="w-full flex items-center justify-center md:justify-start gap-4 p-2 text-slate-600 hover:text-red-400 transition-all group"
            >
      ...
      <main className="flex-1 flex flex-col min-w-0 relative h-full">
        ...
        {/* Top Header - Reference Panel 2 */}
        <header className="h-20 flex items-center justify-between px-8 bg-[#050510] border-b border-white/[0.06] relative z-10">
            <div className="flex-1 max-w-xl relative group">
                ...
                <input 
                    type="text" 
                    placeholder="Search in your quiet corner..." 
                    className="w-full bg-white/5 border border-white/10 rounded-full py-2 pl-12 pr-4 text-sm focus:outline-none focus:border-primary-500/50 focus:bg-white/[0.08] transition-all"
                />
            </div>
            ...
            <div className="flex items-center gap-6 ml-6">
                <button className="p-2 text-slate-500 hover:text-white transition-colors relative">
                    ...
                    <div className="absolute top-2 right-2 w-2 h-2 bg-pink-500 rounded-full border-2 border-[#050510]"></div>
                </button>
                ...
                >
                    ...
                    <div className="w-10 h-10 rounded-full border-2 border-primary-500/30 overflow-hidden group-hover:border-primary-500 transition-all shadow-[0_0_10px_rgba(99,102,241,0.1)]">
                        <div className="w-full h-full bg-primary-600/20 flex items-center justify-center font-bold text-primary-400 capitalize">
